        ...
        <div className="fixed inset-0 bg-bg-dark/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-slate-400 uppercase tracking-widest font-mono">{t("modalCustomTitle")}</label>
              <input
                type="text"
                value={title}
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-slate-400 uppercase tracking-widest font-mono">{t("modalAxis")}</label>
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-slate-400 uppercase tracking-widest font-mono">{t("modalContent")}</label>
