            ...
            >
              <div className="flex flex-col justify-between h-full px-1">
                <div className="flex justify-between items-start gap-4">
                  ...
                  <span className={`text-[11px] font-mono font-black px-2 py-0.5 rounded-full uppercase tracking-widest ${getTierStyle(bg.tierKey)}`}>
                ...
                <div className="mt-4 pt-3.5 border-t border-border-card/80 flex justify-between items-center text-xs text-slate-500 font-mono font-semibold">
