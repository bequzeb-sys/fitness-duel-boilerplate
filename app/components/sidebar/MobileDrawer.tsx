            ...
            <div className="space-y-4 pt-4 border-t border-border-card/60 mt-6">
              ...
              <Card variant="overlay" padding="md" className="space-y-2.5">
                <div className="flex justify-between items-start">
                  <div>
                    <p className="text-[10px] font-medium uppercase tracking-wider text-slate-500">{t("streakLabel")}</p>
              ...
              <Card variant="overlay" padding="md" className="space-y-2">
                ...
                <div className="grid grid-cols-7 gap-1">
                  {streakDays.map((sd, i) => (
                    ...
                    >
                      <span className="text-[8px] font-mono text-slate-500 uppercase">{sd.day}</span>
                      <div
                        className={cn(
