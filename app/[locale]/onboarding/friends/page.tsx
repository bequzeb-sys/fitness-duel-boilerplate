    ...
    <div className="min-h-screen bg-[#050911] text-sans flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-lg">
        ...
        <div className="space-y-6">
          {/* Invite link */}
          <div className="p-5 rounded-xl border border-[#1b2333] bg-[#070b12]">
            ...
            <div className="flex gap-2">
              <input
                ...
                value={inviteLink}
                readOnly
                className="flex-1 px-4 py-2.5 rounded-lg bg-[#050911] border border-[#1b2333] text-slate-400 text-sm"
              />
              <button
                onClick={handleCopy}
                className="px-4 py-2.5 rounded-lg bg-blue-600 text-white text-sm font-medium hover:bg-blue-500 transition-colors shrink-0"
              >
                {copied ? "Copié !" : "Copier"}
              </button>
            </div>
          ...
          <div className="flex items-center gap-4">
            <div className="flex-1 h-px bg-[#1b2333]" />
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-4 py-3 rounded-xl bg-[#070b12] border border-[#1b2333] text-white placeholder-slate-600 focus:outline-none focus:border-blue-500 transition-colors"
              />
              <button
                onClick={handleAddFriend}
                className="px-5 py-3 rounded-xl bg-blue-600 text-white text-sm font-medium hover:bg-blue-500 transition-colors shrink-0"
              >
                Ajouter
              </button>
            </div>
            {addedFriends.length > 0 && (
              <div className="flex flex-wrap gap-2 mt-3">
                {addedFriends.map((f) => (
                  <span key={f} className="px-3 py-1 rounded-full bg-blue-600/20 border border-blue-600/30 text-blue-400 text-xs font-medium">
                    {f}
                  </span>
                ))}
              </div>
