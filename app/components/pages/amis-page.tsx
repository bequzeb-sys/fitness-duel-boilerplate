                  ...
                  <div className="flex gap-3 items-center">
                    ...
                    <div>
                      <h4 className="text-sm font-bold text-white flex items-center gap-1.5">
                        {friend.name}
                        {friend.level === "Maitre" && <span className="text-[11px] font-extrabold px-2 py-0.5 bg-gradient-to-r from-amber-600 to-amber-400 text-white rounded">Elite</span>}
                      </h4>
                      <span className="text-xs text-slate-500 font-medium block mt-0.5">{friend.status}</span>
                    </div>
                  </div>
