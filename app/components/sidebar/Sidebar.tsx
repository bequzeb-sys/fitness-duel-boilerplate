      ...
      <div className="mt-auto p-5 space-y-5 border-t border-border-card/60 shrink-0">
        ...
        <Card variant="overlay" padding="md" className="space-y-2">
          <div className="flex items-center gap-1.5">
            ...
            <span className="ml-auto text-xs font-bold text-slate-200">{t("streakWeek")}</span>
          </div>
          <div className="flex gap-0.5 justify-between">
            {streakDays.map((sd, i) => (
              ...
              >
                <span className="text-[11px] font-mono text-slate-500 group-hover:text-slate-300 transition-colors uppercase">
                  {sd.day}
                </span>
                <div
                  className={cn(
