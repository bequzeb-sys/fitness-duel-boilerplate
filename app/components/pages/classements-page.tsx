    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-end">
        ...
        <div className="bg-gradient-to-b from-amber-950/20 to-bg-card border border-amber-500/30 rounded-3xl p-6 flex flex-col items-center justify-between text-center min-h-[250px] shadow-[0_8px_32px_rgba(251,191,36,0.1)] md:order-2 order-1 ring-2 ring-amber-500/20 relative">
          <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-amber-500 text-slate-950 font-black text-xs px-3 py-1 rounded-full uppercase tracking-wider shadow-lg">
            {t("pomodoroChamp")} &#x1F451;
          </div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  {item.isYou && <span className="text-[11px] font-bold px-2 py-0.5 bg-brand-blue text-bg-dark rounded uppercase tracking-widest font-sans">{t("rankings")}</span>}
                </div>
              </div>
