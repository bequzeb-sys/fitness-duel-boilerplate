      ...
      <div className="flex items-center gap-1.5 mb-1.5">
        {!isUser && (
          <Avatar
            ...
            shape="circle"
            fallback="A"
            className="bg-brand-blue text-bg-dark font-bold text-xs"
          />
        )}
        <span className="text-xs text-slate-500 font-bold font-mono">{senderName}</span>
      </div>
              ...
              <div className="flex items-center gap-1.5">
                ...
                {onSave && (
                  <Button
                    ...
                    onClick={onSave}
                    title={t("savePlan")}
                    className="text-brand-blue hover:text-white text-xs"
                  >
