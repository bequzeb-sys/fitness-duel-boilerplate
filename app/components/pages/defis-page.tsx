          ...
          <Card key={chal.id} variant="interactive" padding="none" className="flex flex-col h-full">
            ...
            <div className="p-5 flex-grow space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2 pt-2 border-t border-border-card/60 text-xs font-mono">
                <div>
                  <span className="text-slate-500 block text-[9px] uppercase font-bold">{t("participants")}</span>
            ...
            return (
              <Card key={idx} padding="md" className="flex flex-col justify-between hover:border-slate-600">
                <div className="flex justify-between items-start gap-2">
                  <div>
                    <span className="text-[9px] font-mono font-bold text-brand-cyan bg-brand-cyan/10 px-2 py-0.5 rounded uppercase tracking-wider">
                      {s.cat}
                    </span>
                ...
                <div className="flex justify-between items-center text-[10px] text-slate-500 font-mono mt-4 pt-2.5 border-t border-border-card/60">
