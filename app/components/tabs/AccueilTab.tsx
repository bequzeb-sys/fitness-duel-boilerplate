    ...
    >
      ...
      <div className="lg:col-span-8 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <div className="md:col-span-8 relative min-h-[240px] sm:h-[220px] flex flex-col justify-end">
            ...
            <Card padding="lg" className="flex flex-col justify-between min-h-[240px] sm:h-[220px]">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <h3 className="text-lg sm:text-base font-display font-extrabold text-white tracking-tight">{t("currentXp")} {userXp >= 2000 ? "III" : userXp >= 1000 ? "II" : "I"}</h3>
                </div>
              </div>
          ...
          <Card padding="lg" className="space-y-4">
            ...
            <div className="space-y-3">
              <AnimatePresence initial={false}>
                {challenges.map((chal) => (
                  <Card key={chal.id} variant="interactive" padding="none" className="flex min-h-[5.5rem] sm:h-20" onClick={() => addToast(t("challengeSelected", { title: chal.title }), "info")}>
                    {/* Left picture cover */}
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-4 text-center sm:text-left">
              ...
              <div>
                ...
                <p className="text-xs text-bg-dark/85 font-medium">{t("ctaSubtitle")}</p>
              </div>
            </div>
          ...
          <Card padding="lg" className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2 pt-2">
                <p className="text-xs text-slate-500 font-semibold uppercase tracking-wider">{t("shareOrCopy")}</p>
                ...
                >
                  <div className="flex flex-col items-center justify-between h-full w-full gap-1">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] text-slate-500 font-medium mt-0.5 whitespace-nowrap truncate max-w-full">{t(bd.descKey)}</p>
                    </div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    {leader.isYou && <span className="text-[11px] font-bold text-brand-blue bg-brand-blue/10 px-2 py-0.5 rounded uppercase tracking-wider">{t("me")}</span>}
                  </div>
                </div>
        ...
        <Card padding="lg" className="flex flex-col justify-between min-h-[420px] sm:h-[390px] sm:min-h-[390px]">
          <div className="flex justify-between items-center pb-2 border-b border-border-card/60">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-bold px-2 py-0.5 bg-brand-blue text-bg-dark rounded uppercase tracking-wider">
                {t("new")}
              </span>
            </div>
            <Button
            ...
            {messages.map((m) => (
              ...
              >
                <div className="flex items-center gap-1.5 mb-1">
                  {m.sender === "coach" && (
                    <div className="h-5 w-5 rounded bg-brand-blue flex items-center justify-center text-xs text-bg-dark">
                      A
                    </div>
                  )}
            ...
            {coachTyping && (
              <div className="flex flex-col items-start">
                <div className="flex items-center gap-1.5 mb-1">
                  ...
                  <span className="text-xs text-slate-500 font-semibold font-mono">{t("chatCoach")}</span>
                </div>
