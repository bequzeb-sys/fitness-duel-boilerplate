    ...
    >
        ...
        <Card padding="xl" className="space-y-6">
          ...
          <div className="p-4 bg-gradient-to-r from-[#040c1a] to-bg-surface-input border border-border-card rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-xs uppercase font-bold text-slate-400 font-mono">{t("imcTitle")}</p>
            ...
            <div className="flex items-center gap-4 text-right">
              <div>
                <span className="block text-xs text-slate-500 font-mono uppercase">{t("imcIndex")}</span>
              ...
              <div className="border-l border-border-card pl-4">
                <span className="block text-xs uppercase font-mono text-slate-500">{t("imcDiagnostic")}</span>
      ...
      <div className="lg:col-span-4 space-y-6">
        ...
        <Card variant="overlay" padding="lg" className="space-y-3">
          ...
          <Progress value={72.5} />
          <p className="text-xs text-slate-500 text-right">{t("weeklyReport")}</p>
        </Card>
